  ...
  sections.forEach(current => {
    ...
    */
    if (
      ...
      document.querySelector(".navigation a[linksection*=" + sectionId + "]").classList.add("active");
    } else {
      document.querySelector(".navigation a[linksection*=" + sectionId + "]").classList.remove("active");
    }
  });
}