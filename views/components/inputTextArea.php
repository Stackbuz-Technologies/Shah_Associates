<textarea cols="<?php echo $inputTextCols; ?>" rows="<?php echo $inputTextRows; ?>"  id = "<?php echo $inputId; ?>" name = "<?php echo $inputName; ?>" <?php if ($inputReadOnly != '') { ?>readonly="<?php echo $inputReadOnly; ?>"<?php } ?>
                   ...
                   <?php if ($inputDisabled == 'Y') { ?> 
                    disabled
                   <?php } ?>><?php echo $inputFieldValue; ?></textarea>